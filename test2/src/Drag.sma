 ...
 */
_define_
Drag (Process shape, Process transforms, Process frame) {
  ...
  FSM fsm {
    ...
    State dragging {
        ...
        //The shape cannot get outside its frame
      //shape.move.local_x - shape.press.local_x =:> transforms.rightTranslateBy.dx
        Text l (0,0,"0")
        frame.move.y - shape.move.local_y => l.text
        /*
        @ruleset moveable {x_movement : false, y_movement : true, frame_restricted : true}
        @ensures moveable
        */
